...
export const getEnrichedMarketsQueryOptions = (
  ...
  queryFn: async () => {
    ...
    const result = await client.rpc("get_enriched_markets", {
      ...
      // filters: filterClauses, // TODO: For 11155111 bera Test
      filters: "(input_token_id = '11155111-0xd34398848d35b2bd2ca373c809dc4d8e0523b00f'::text) AND (incentive_ids @> ARRAY['11155111-0x2f6f07cdcf3588944bf4c42ac74ff24bf56e7590']::text[]) AND (chain_id = 11155111)",
