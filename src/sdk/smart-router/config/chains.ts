export default {
  ...
  59144: {
    ...
    nativeCurrency: { name: 'ETH', symbol: 'ETH', decimals: 18 },
    rpcUrls: ['https://1rpc.io/linea', 'https://linea.blockpi.network/v1/rpc/public'],
  ...
  80084: {
    ...
    rpcUrls: ['https://bartio.rpc.berachain.com/', 'https://bartio.drpc.org', 'https://bera-testnet.nodeinfra.com'],
