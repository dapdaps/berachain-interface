    ...
    <AnimatePresence mode="wait">
      {
        store.open ? (
          <motion.div
            className="fixed z-[50] top-[8px] left-[50%] translate-x-[-50%] flex justify-start items-center gap-[9px] w-[445px] border border-black bg-[#FFFDEB] shadow-shadow1 rounded-[20px] px-[15px] py-[12px]"
            style={{
              x: '-50%',
            }}
            variants={{
