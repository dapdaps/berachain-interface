          ...
          Object.values(GameLootbox).filter((box) => !box.disabled).map((box, index) => {
            ...
            return (
              <div key={index} className="group w-[212px] h-[212px] relative flex justify-center items-center">
                <div
                  className={clsx(
                    "w-full h-full rounded-[20px] border-[3px] border-[#8B6A45] overflow-hidden bg-no-repeat bg-center bg-contain",
                    !isBalanceBox ? "bg-[#FFFFFF33] border-dashed bg-[url('')]" : "bg-[#D39924] bg-[url('/images/treasure-book/bg-lights.png')]",
                  )}
                />
                {
                  isBalanceBox && (
                ...
                <div className="w-full h-full absolute z-[3] flex justify-center items-center">
                  ...
                  <img
                    ...
                    alt=""
                    className={clsx(
                      "w-[162px] h-[128px] shrink-0 object-center object-contain",
                      !isBalanceBox && "opacity-10",
                    )}
                  />
                </div>
              </div>
