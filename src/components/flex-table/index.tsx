        ...
        <div className={`flex items-center py-[14px] ${headClass}`}>
          {
            columns.map((column: any, columnIdx) => (
              <div
                ...
                onClick={() => {
                  column?.sort && onChangeSortDataIndex && onChangeSortDataIndex(column?.dataIndex)
                }}
              >
                {renderTitle ? renderTitle(column, columnIdx) : column.title}
                {
                  column?.sort && (
                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="8" viewBox="0 0 13 8" fill="none">
                      <path d="M5.37058 7.5C5.88774 8.16667 7.18062 8.16667 7.69778 7.5L12.3522 1.5C12.8693 0.833334 12.2229 4.76837e-07 11.1886 4.76837e-07H1.87979C0.845482 4.76837e-07 0.199039 0.833334 0.716193 1.5L5.37058 7.5Z" fill={sortDataIndex === column?.dataIndex ? "black" : '#D1CEB4'} />
                    </svg>
                  )
                }
              </div>
