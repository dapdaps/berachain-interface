        ...
        <div className='flex justify-start items-center gap-x-[20px]'>
          ...
          >
            <Popover
              ...
              content={(
                <div className='w-[266px] py-[24px] pl-[22px] pr-[26px] rounded-[12px] bg-white border border-[#F0F0F0] shadow-[0px_15px_30px_0px_rgba(0,_0,_0,_0.30)]'>
                  <div className='text-[#6F6F6F] text-[16px] font-normal text-nowrap leading-[1] overflow-hidden overflow-ellipsis'>
