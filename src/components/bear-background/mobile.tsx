        ...
        type === "bgt-lst" ? (
          <>
            <div className='absolute bottom-0 left-0 right-0'>
              <img className='w-full' src="/images/background/lst-ground-mobile.svg" alt="lst-ground-mobile" />
            </div>
            <div className='absolute w-[336px] right-0 bottom-0'>
              <img className='w-full' src="/images/background/lst-tree-mobile.png" alt="lst-tree-mobile" />
            </div>
          </>
        ) : (
          <Clouds />
