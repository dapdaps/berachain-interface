...
const RightTree = function () {
  return (
    <div className="absolute right-0 bottom-0">
      ...
      {/* hat */}
      <svg className='absolute bottom-[500px] right-[33px]' xmlns="http://www.w3.org/2000/svg" width="90" height="90" viewBox="0 0 90 90" fill="none">
        <path d="M22.8075 64.1203C25.317 65.5975 32.6393 66.9591 33.0308 65.4361C33.4224 63.9134 31.9047 62.2251 29.2222 62.1582C26.3946 62.0878 22.171 61.2751 20.4479 59.4638C20.1887 60.4005 20.2979 62.6431 22.8075 64.1203Z" fill="#4B565C" stroke="black" />
        <path d="M30.4473 64.1711C28.7212 62.8081 31.6964 61.7306 33.0729 61.6732L37.3605 66.18C35.9932 65.8709 32.1733 65.5342 30.4473 64.1711Z" fill="#4B565C" stroke="black" />
        <path d="M31.9372 54.1676C36.6037 52.3039 44.3428 45.5851 47.629 42.4587C32.1933 26.234 35.3607 19.7863 38.8739 18.5905C45.891 16.5654 63.1082 17.2145 75.8397 36.0118C91.7542 59.5084 57.7181 79.0101 49.5554 75.5067C41.3927 72.0033 26.1042 56.4973 31.9372 54.1676Z" fill="#FFD152" stroke="black" />
        <path d="M57.1316 47.3703C58.2857 45.1991 56.623 45.7077 44.873 31.6648C39.7606 24.9373 38.7525 19.7789 38.8875 18.0407C35.4083 14.1956 28.5724 8.21359 29.0621 15.0458C29.6743 23.5861 40.9158 35.9662 46.2891 41.0501C51.6624 46.134 55.9774 49.5416 57.1316 47.3703Z" fill="white" stroke="black" />
        <path d="M45.995 22.0738C47.8036 21.3142 51.8186 21.0213 57.0429 23.7892" stroke="black" stroke-linecap="round" />
        <path d="M58.6735 24.9475C59.1393 25.2785 59.8381 25.7749 60.3039 26.1058" stroke="black" stroke-linecap="round" />
        <path d="M69.5651 37.2126C67.231 33.1427 61.3164 33.2245 57.2 34.0634C55.9478 34.3186 55.4094 35.7427 56.1618 36.7757C63.553 46.9244 72.916 43.0555 69.5651 37.2126Z" fill="#725D41" stroke="black" />
      </svg>
      {/* arm */}
      <motion.svg
        animate={{
  ...
  return (
    <div {...{ ...props }}>
      ...
      {/* <motion.svg
        ...
        className='absolute top-[14px] right-[93px]' xmlns="http://www.w3.org/2000/svg" width="212" height="200" viewBox="0 0 212 200" fill="none">
        <path d="M154.517 12.1908C157.744 13.794 159.076 17.7708 159.178 20.8751C159.218 22.1012 157.948 22.7933 156.842 22.2636C145.498 16.8336 149.643 9.76985 154.517 12.1908Z" fill="#725D41" stroke="black"></path>
        <path d="M160.552 63.7063C157.65 63.4571 150.893 60.3264 151.455 58.8582C152.018 57.39 154.233 56.8926 156.459 58.3917C158.805 59.9718 162.718 61.7554 165.172 61.2768C164.841 62.1905 163.453 63.9554 160.552 63.7063Z" fill="#4B565C" stroke="black"></path>
        <path d="M154.294 59.3231C156.491 59.2116 154.689 56.6101 153.6 55.7661L147.495 56.957C148.789 57.4969 152.098 59.4347 154.294 59.3231Z" fill="#4B565C" stroke="black"></path>
        <path d="M158.873 50.3052C156.148 46.0833 153.73 36.1238 152.862 31.6719C174.842 27.3848 175.994 20.2941 173.823 17.2846C169.275 11.5697 154.863 2.12749 133.598 10.0779C107.016 20.016 123.468 55.6262 132.152 57.4976C140.835 59.369 162.279 55.5826 158.873 50.3052Z" fill="#FFD152" stroke="black"></path>
        <path d="M142.271 30.1725C142.587 27.7341 143.648 29.1116 161.36 24.4686C169.424 21.9451 173.233 18.3237 174.13 16.8284C179.193 15.7089 188.23 14.7912 183.874 20.0773C178.429 26.685 162.095 30.267 154.77 31.2996C147.445 32.3321 141.954 32.611 142.271 30.1725Z" fill="white" stroke="black"></path>
        <path d="M166 16C164.966 14.3333 161.862 11.7692 156 11" stroke="black" stroke-linecap="round"></path>
        <path d="M154 11C153.429 11 152.571 11 152 11" stroke="black" stroke-linecap="round"></path>
        <path d="M138.017 14.6909C142.277 12.7248 147.051 16.217 149.921 19.2849C150.794 20.2182 150.408 21.6909 149.197 22.0973C137.294 26.0901 131.901 17.5135 138.017 14.6909Z" fill="#725D41" stroke="black"></path>
      </motion.svg> */}
    </div>
  )
}
  ...
  return (
    <div className="absolute right-0 bottom-0 z-10">
      ...
      <motion.svg
        ...
        className='absolute right-0 bottom-0' width="172" height="185" viewBox="0 0 172 185" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M171.532 176.282C163.092 195.866 145.552 209.148 137.837 213.341C142.561 199.142 155.564 165.633 169.786 145.193C187.565 119.644 217.759 114.631 219.051 125.839C220.343 137.046 182.083 151.802 171.532 176.282Z" fill="#14653C" stroke="black" />
        <path d="M85.0989 161.048C111.512 167.981 129.072 183.564 134.551 190.489C133.447 170.826 111.202 153.007 93.0764 149.422C74.9506 145.837 52.0825 152.382 85.0989 161.048Z" fill="#14653C" stroke="black" />
        <path d="M133.781 201.915C131.108 154.309 118.528 127.158 112.573 119.533C112.91 109.786 116.732 96.7478 129.325 122.572C145.067 154.852 137.122 261.422 133.781 201.915Z" fill="#14653C" stroke="black" />
        <path d="M102.505 14.3051C154.505 -8.89487 163.505 2.99512 180.005 14.3051C212.343 46.9952 196.505 73.8053 163.505 86.3053C130.505 98.8053 141.505 135.305 111.505 144.805C87.505 152.405 69.8383 137.639 64.005 129.305C43.1717 133.305 1.405 130.305 1.005 86.3053C0.505005 31.3053 37.505 43.3051 102.505 14.3051Z" fill="#F08A95" stroke="black" />
        <path d="M132.128 18.1637C150.528 3.76374 167.461 20.1637 173.628 30.1637C179.628 47.6639 180.628 63.6636 145.628 80.1636C110.628 96.6636 117.628 113.664 73.1282 121.664C28.6282 129.664 9.62816 63.6636 34.6282 49.1636C59.6282 34.6636 71.1282 68.6636 93.6282 63.6636C116.128 58.6636 109.128 36.1637 132.128 18.1637Z" fill="#E36974" />
        <path d="M75.8435 54.3453C59.8435 68.8453 73.3435 76.8453 91.8435 71.3453C100.422 68.7948 107.624 63.3212 112.843 58.0016C104.843 44.658 91.8435 39.8453 75.8435 54.3453Z" fill="#EBF479" />
        <path d="M120.843 47.8453C119.372 50.3674 116.629 54.144 112.843 58.0016M112.843 58.0016C107.624 63.3212 100.422 68.7948 91.8435 71.3453C73.3435 76.8453 59.8435 68.8453 75.8435 54.3453C91.8435 39.8453 104.843 44.658 112.843 58.0016Z" stroke="black" />
      </motion.svg>
      ...
      <motion.svg
        ...
        className='absolute bottom-[40px] right-[227px]' width="105" height="99" viewBox="0 0 105 99" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M25.413 77.7593C30.0379 87.009 38.9022 92.9613 42.7562 94.7813C40.0798 88.0367 32.8642 72.171 25.413 62.6643C16.0991 50.7811 1.32532 49.1752 1.00415 54.6351C0.682983 60.095 19.632 66.1972 25.413 77.7593Z" fill="#14653C" stroke="black" />
        <path d="M66.8438 68.1246C54.2539 72.2356 46.1819 80.3291 43.7196 83.8619C43.7196 74.2269 53.997 64.9129 62.6686 62.6647C71.3402 60.4165 82.5811 62.9859 66.8438 68.1246Z" fill="#14653C" stroke="black" />
        <path d="M44.3621 89.3217C44.3621 66.1975 49.7149 52.7083 52.3913 48.8543C51.9631 44.1438 49.7577 37.9345 44.3621 50.7813C37.6175 66.8398 44.3621 118.227 44.3621 89.3217Z" fill="#14653C" stroke="black" />
        <path d="M14.4933 4.42765C27.5971 -4.05122 58.4936 5.17705 72.3039 10.851C119.675 20.486 114.056 52.2821 54.9607 51.6397C-4.1345 50.9974 -1.88631 15.0262 14.4933 4.42765Z" fill="#F0775C" stroke="black" />
        <path d="M23.6442 11.8281C33.1166 5.69892 55.451 12.3698 65.4342 16.4715C99.6778 23.4364 95.616 46.4211 52.8972 45.9567C10.1785 45.4924 11.8036 19.4896 23.6442 11.8281Z" fill="#E35B4B" />
        <path d="M61.3439 32.6077C65.7118 30.5523 58.2393 26.1844 53.957 24.2573C48.4972 22.3303 43.0372 20.4033 42.0737 25.2208C41.1102 30.0384 55.884 35.1771 61.3439 32.6077Z" fill="#F3AD11" stroke="black" />
      </motion.svg>

      <motion.svg className="absolute bottom-0 right-[102px]" xmlns="http://www.w3.org/2000/svg" width="83" height="72" viewBox="0 0 83 72" fill="none">
        <path d="M34.6847 56.6221C26.2442 76.206 8.70457 89.4885 0.989837 93.6818C5.71345 79.4822 18.7163 45.9732 32.939 25.5337C50.7172 -0.0155732 80.9115 -5.0288 82.2034 6.17884C83.4952 17.3865 45.2353 32.1422 34.6847 56.6221Z" fill="#14653C" stroke="black" />
      </motion.svg>
