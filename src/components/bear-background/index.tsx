...
const RightTree = function () {
  return (
    <div className="absolute right-0 bottom-0">
      <svg width="260" height="891" viewBox="0 0 260 891" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
      ...
      <motion.svg
        ...
        className='absolute z-10 bottom-[460px] right-[73px]' xmlns="http://www.w3.org/2000/svg" width="104" height="136" viewBox="0 0 104 136" fill="none">
        <path d="M39.4971 17.0227C48.4119 34.5876 81.4225 70.4987 93.3743 84.6473C109.779 112.765 88.7288 139.006 72.8989 134.379C53.1114 128.595 24.7593 35.4563 21.7348 23.3277C18.7104 11.1991 5.02386 15.6633 5.35878 7.16994C5.6937 -1.32346 28.3535 -4.93341 39.4971 17.0227Z" fill="#725D41" />
        <path d="M93.3743 84.6473C81.4225 70.4987 48.4119 34.5876 39.4971 17.0227C28.3535 -4.93341 5.6937 -1.32346 5.35878 7.16994C5.02386 15.6633 18.7104 11.1991 21.7348 23.3277C24.7593 35.4563 53.1114 128.595 72.8989 134.379" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
      </motion.svg>
      ...
      <motion.svg
        ...
        className='absolute bottom-[633px] right-[199px]' xmlns="http://www.w3.org/2000/svg" width="18" height="17" viewBox="0 0 18 17" fill="none"
      >
        <path d="M10.909 1.55037C7.73088 2.1984 7.69587 5.47846 8.15428 7.72667L9.81245 7.79535C9.81245 7.79535 11.1781 7.11012 11.8914 6.36787C14.0462 4.12582 12.8359 1.15748 10.909 1.55037Z" fill="white" stroke="black" stroke-linecap="round" />
        <path d="M4.10367 12.4721C3.78933 10.9304 4.54329 9.70623 4.95957 9.28682C7.85012 8.69744 10.5442 7.14454 11.3113 5.98456C12.0783 4.82458 16.1289 5.00225 16.3347 8.47279C16.5406 11.9433 12.4994 14.2727 8.64536 15.0585C5.5621 15.6872 4.97834 14.3008 4.30012 13.4355L2.75663 13.2485L4.10367 12.4721Z" fill="#FEEF48" stroke="black" stroke-linecap="round" />
        <path d="M4.10368 12.4722C3.78934 10.9306 4.47777 9.38496 5.92304 9.09027C5.92304 9.09027 5.09034 9.92828 5.54895 12.1775C6.24355 15.584 8.64537 15.0587 8.64537 15.0587C8.64537 15.0587 5.37124 16.2278 4.30012 13.4356L2.75663 13.2487L4.10368 12.4722Z" fill="black" />
        <path d="M7.36812 8.79563C7.50223 10.2736 7.65471 13.1529 9.51068 14.3802" stroke="black" stroke-linecap="round" />
        <path d="M10.0859 7.23791C10.22 8.71593 11.6479 12.4391 13.9807 12.4652" stroke="black" stroke-linecap="round" />
        <path d="M4.89616 3.3732C7.82225 1.97371 9.4706 6.12025 9.92901 8.36846L8.43009 9.08087C8.43009 9.08087 6.90521 8.98502 5.9582 8.58131C3.09767 7.36188 1.23855 5.12256 4.89616 3.3732Z" fill="white" stroke="black" stroke-linecap="round" />
        <path d="M11.9202 7.36567C11.468 6.78881 10.8135 5.38346 11.8126 4.37689" stroke="black" stroke-linecap="round" />
        <path d="M14.3 5.87684C14.1952 5.36296 14.1627 4.21883 14.8706 3.75334" stroke="black" stroke-linecap="round" />
      </motion.svg>
      {/* right bee */}
      <motion.svg
        animate={{
        ...
        className='absolute bottom-[667px] right-[72px]' xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
        <path d="M6.45559 0.794247C9.63374 1.44227 9.66876 4.72233 9.21035 6.97054L7.55217 7.03922C7.55217 7.03922 6.18655 6.35399 5.47321 5.61174C3.31847 3.36969 4.5287 0.401353 6.45559 0.794247Z" fill="white" stroke="black" stroke-linecap="round" />
        <path d="M13.261 11.7159C13.5753 10.1743 12.8213 8.95009 12.4051 8.53069C9.5145 7.9413 6.82041 6.3884 6.05335 5.22842C5.28629 4.06844 1.23576 4.24611 1.0299 7.71666C0.824046 11.1872 4.86519 13.5166 8.71926 14.3024C11.8025 14.9311 12.3863 13.5446 13.0645 12.6794L14.608 12.4924L13.261 11.7159Z" fill="#FEEF48" stroke="black" stroke-linecap="round" />
        <path d="M13.2609 11.7161C13.5753 10.1744 12.8869 8.62883 11.4416 8.33413C11.4416 8.33413 12.2743 9.17214 11.8157 11.4214C11.1211 14.8279 8.71926 14.3025 8.71926 14.3025C8.71926 14.3025 11.9934 15.4717 13.0645 12.6795L14.608 12.4925L13.2609 11.7161Z" fill="black" />
        <path d="M9.9965 8.03949C9.8624 9.51751 9.70991 12.3968 7.85394 13.6241" stroke="black" stroke-linecap="round" />
        <path d="M7.27877 6.48178C7.14467 7.9598 5.71677 11.683 3.38394 11.7091" stroke="black" stroke-linecap="round" />
        <path d="M12.4685 2.61707C9.54237 1.21758 7.89403 5.36413 7.43562 7.61234L8.93453 8.32474C8.93453 8.32474 10.4594 8.22889 11.4064 7.82519C14.267 6.60575 16.1261 4.36644 12.4685 2.61707Z" fill="white" stroke="black" stroke-linecap="round" />
        <path d="M5.44443 6.60954C5.89658 6.03268 6.55111 4.62732 5.55206 3.62075" stroke="black" stroke-linecap="round" />
        <path d="M3.0646 5.1207C3.16938 4.60683 3.20195 3.4627 2.494 2.9972" stroke="black" stroke-linecap="round" />
      </motion.svg>
