...
const Dashboard = (props: any) => {
  ...
  return (
    <div className={clsx("text-[20px] text-black leading-[90%] font-[600] font-Montserrat bg-[#FFDC50] rounded-[10px] p-[20px_24px_23px_31px] flex justify-between items-start", className)}>
