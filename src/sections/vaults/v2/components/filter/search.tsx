...
const Search = (props: any) => {
  ...
  return (
    <motion.div
      className={clsx("flex items-center justify-end gap-[5px] p-[5px]", className)}
      animate={{
    ...
    >
      ...
      <button
        ...
        style={{
          backgroundImage: `url("${hasValue ? '/images/vaults/v2/clear.png' : '/images/vaults/v2/search.svg'}")`
        }}
