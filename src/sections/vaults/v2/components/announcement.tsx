...
const Announcement = (props: any) => {
  ...
  return (
    <div className="w-[560px] absolute z-[51] left-1/2 -translate-x-1/2 top-[17px] flex justify-center items-center gap-[10px]">
      <motion.div
        className={clsx("cursor-pointer p-[0] whitespace-nowrap justify-center w-[396px] h-9 shrink-0 rounded-[10px] border border-black bg-[#FFF5A9] shadow-[4px_4px_0px_0px_rgba(0,0,0,0.25)] text-black font-montserrat text-sm font-medium leading-none flex items-center gap-[11px]", className)}
        initial={{
          y: -100,
          opacity: 0,
        }}
      ...
      <AnimatePresence mode="wait">
        {
          Big((userPoints as any)?.points || 0).gt(0) && (
            <motion.div
