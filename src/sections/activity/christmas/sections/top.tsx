        ...
        <div className="flex flex-col items-center gap-[0px]">
          <div className="relative w-[791px] h-[254px]">
            <button
              ...
              className="absolute right-[90px] top-[104px] w-[68px] h-[32px] rounded-[20px] border border-black bg-[#B5956E] text-[#FFF5A9] shadow-[-20px_26px_60px_0px_rgba(0, 0, 0, 0.20)_inset]"
            >
              Rules
            </button>
            <img
