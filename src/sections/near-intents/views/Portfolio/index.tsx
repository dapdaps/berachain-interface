  ...
  const renderMainContent = () => (
    <div className="px-[20px] py-[16px] pb-[30px]">
      ...
      <div className="flex items-center justify-between gap-2 my-5">
        <button className="w-1/2 h-[50px] bg-[#FFDC50] border border-black text-[14px] rounded-[10px] font-Montserrat font-[600]">
          Deposit
        </button>
        <button className="w-1/2 h-[50px] bg-[#FFDC50] border border-black text-[14px] rounded-[10px] font-Montserrat font-[600]">
          Withdraw
    ...
    <div className="w-[340px] mr-5 bg-[#FFFDEB] h-[680px] border border-[#373A53] rounded-[30px] shadow-shadow1 overflow-hidden">
      <div className="flex items-center bg-[#FFDC50] justify-between border-b border-[#373A53] pt-[20px] pb-[12px] pl-[26px] pr-[20px]">
        ...
        <div className="flex items-center gap-2.5">
          <img src="/images/near-intents/icons/wallets/evm.png" className="w-[32px] h-[32px]" alt="" />
          <img src="/images/near-intents/icons/wallets/sol.png" className="w-[32px] h-[32px]" alt="" />
          <img src="/images/near-intents/icons/wallets/near.png" className="w-[32px] h-[32px]" alt="" />
        </div>
      </div>
      {showHistory ? (
