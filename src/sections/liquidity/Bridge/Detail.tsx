    ...
    <div>
      <div className="relative mb-[24px] pt-[16px] pl-[73px] h-[146px] rounded-[10px] bg-[#FFDC50]">
        ...
        <div className="mb-[17px] flex items-center gap-[14px]">
          ...
          <div className="text-black font-Montserrat text-[26px] font-semibold leading-[100%]">{data?.initialData?.pool?.name}</div>
        </div>
        <div className="flex items-center">
          ...
          <div className="flex flex-col gap-[12px] w-[130px]">
            ...
            <div className="text-black font-Montserrat text-[20px] font-semibold leading-[90%]">{data?.initialData?.pool?.protocol}</div>
          </div>
          <div className="flex flex-col gap-[12px] w-[130px]">
          ...
          <div className="pt-[21px] pr-[2px] pb-[46px] pl-[17px]">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-[10px]">
                ...
                <div className="text-black font-Montserrat text-[16px] font-semibold leading-[100%]">{data?.initialData?.pool?.name}</div>
              </div>
              ...
              >
                <span className="text-black font-Montserrat text-[18px] font-semibold leading-[90%]">Mint LP</span>
              </div>
            </div>
          </div>
