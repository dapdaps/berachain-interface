      ...
      render: (text: any, record: any) => {
        return (
          <div className="relative text-[#3D405A] text-[14px] font-[600] flex items-center gap-[12px]">
            <div className="">
              {numberFormatter(record.supporters, 0, true, { isShort: isMobile })}
            </div>
            {
              !isMobile ? (
                <Popover
                ...
                >
                  <button
                    type="button"
                    className="h-[28px] leading-[26px] whitespace-nowrap px-[10px] border border-black disabled:cursor-[default!important] rounded-[10px] bg-[#FFDC50] flex justify-center items-center gap-[5px] text-center text-black text-[14px] font-[600]"
                    style={record.voted ? {
                      background: '#7CB424',
                      borderColor: '#7CB424',
                      color: '#FFF',
