...
const Confirm = ({ loading, onConfirm }: any) => {
  return (
    <>
      <div className="max-w-[212px] md:max-w-[unset]">
        Each round can only vote for one MEME token once, after voting can not
        be changed.
      </div>
...
const VoteConfirm = (props: any) => {
  ...
  return isMobile ? (
    <Drawer visible={visible} onClose={onClose} size="30dvh">
