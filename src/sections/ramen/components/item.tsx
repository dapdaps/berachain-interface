...
const Item = (props: any) => {
  ...
  return (
    <div
      className={clsx(
        "cursor-pointer text-black font-[500] text-[16px] leading-[90%] font-Montserrat bg-[rgba(0,_0,_0,_0.06)] rounded-[10px] p-[10px_15px_7px] grid grid-cols-[280px_115px_180px_130px_90px_1fr] items-center",
        className
      )}
      onClick={onClick}
    >
