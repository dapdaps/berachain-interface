            ...
            <div onClick={() => { setTokenSelectorShow(true) }} className="border cursor-pointer flex items-center justify-between border-[#000] rounded-[8px] bg-[#FFFDEB] w-[176px] h-[46px] px-[7px]">
                <div className="flex items-center gap-[10px]">
                    <div className="relative">
                        ...
                        <img className="w-[10px] h-[10px] absolute right-0 bottom-0" src="https://s3.amazonaws.com/dapdap.main/avatar/0x86cdcd7fa9f3b24d68cbdd9170c3662036bdc2ef1727332750443" />
                    </div>
                    <div>
