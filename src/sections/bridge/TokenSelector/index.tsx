            ...
            <div className="w-[520px]">
                <div className="flex items-center gap-[10px] cursor-pointer text-[20px]">
                    <svg width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7 2L2.2 8L7 14" stroke="black" stroke-width="3" stroke-linecap="round" />
                    </svg>
                ...
                <div className="mt-[20px] flex items-center border rounded-[12px] overflow-hidden border-[#373A53] px-[15px] gap-[10px]">
                    <svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <rect x="14.9138" y="9.64978" width="6.141" height="2.63186" rx="1.31593" transform="rotate(30 14.9138 9.64978)" fill="#3D4159" />
                    </svg>

                    <input className="flex-1 h-[52px] bg-inherit outline-none" placeholder="search token or paste address" />
                </div>
