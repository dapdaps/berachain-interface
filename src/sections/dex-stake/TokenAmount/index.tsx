    ...
    <div className={clsx("border border-[#000] rounded-[12px] p-[14px] bg-white leading-[100%]", className)}>
      <div className="flex items-center justify-between gap-[10px]">
        <div className="flex-1">
          <input
            className="w-[100%] h-[100%] text-[26px]"
            value={amount}
            onChange={(ev) => {
        ...
        <div
          className={`${outputCurrencyReadonly ? "" : ""
            } flex items-center justify-between   w-[156px] h-[46px] px-[7px] cursor-pointer ${currencyClassName ?? ""}`}
          onClick={() => {
            onCurrencySelectOpen?.();
          }}
        >
