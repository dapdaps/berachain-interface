        ...
        <div className="relative h-full flex flex-col flex-1 py-[34px] px-[15px] justify-between">
          <div className="flex flex-col gap-[12px]">
            ...
            <div className="flex items-center gap-[10px]">
              ...
              <div className="text-black font-Montserrat text-[26px] font-semibold leading-[90%] whitespace-nowrap">{formatValueDecimal(pageData?.polGetGlobalInfo?.annualizedBGTEmission, "", 2, true)} Yearly</div>
            </div>
          </div>
