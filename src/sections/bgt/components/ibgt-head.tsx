...
const IbgtHead = (props: any) => {
  ...
  return (
    <div className={`relative z-20 mb-[25px] ${className}`} style={style}>
      ...
      <div
        className={`min-w-[278px] h-[88px] p-[10px] rounded-[30px] bg-[#F4A634] shadow-[1px_1px_0px_0px_#77481E] ${innerClassName}`}
        style={innerStyle}
      >
        <div
          ...
          style={valueStyle}
        >
          {formatValueDecimal(count, '', 6, false, false)} iBGT
        </div>
      </div>
    </div>
  );
