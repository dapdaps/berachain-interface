...
const BeraPrice = (props: any) => {
  ...
  return (
    <div onClick={() => router.push('/marketplace')} className={clsx('absolute pt-[10px] flex flex-col items-center right-[10px] bottom-0 z-[5] w-[137px] h-[124px] overflow-hidden bg-[url("/images/home-earth/bera-price-signpost.svg")] bg-no-repeat bg-center bg-contain', className)}>
