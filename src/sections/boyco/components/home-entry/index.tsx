...
const HomeEntry: React.FC<{ onOpenModal: () => void }> = ({ onOpenModal }) => {
  return (
    <div className="lg:absolute md:absolute lg:top-[-118px] lg:scale-[0.8] lg:left-[calc(50%-159px)] w-[318px] h-[200px] flex justify-center pt-[40px] z-[60] md:scale-[0.8] md:left-[-20px] md:top-[40px]">
