        ...
        <div className="flex flex-col gap-[12px]">
          ...
          >
            <Item
              ...
              value={`${data?.initialData?.pointsMultiplier}x`}
            />
          </Popover>
        </div>
        <div className="flex flex-col gap-[12px]">
          ...
          <>
            <div className="flex flex-col gap-[12px]">
              ...
              <Item
                ...
                height={18}
                className=""
                value={numberFormatter(data?.withdrawTokenPrice, 2, true, {
                  prefix: "$"
                })}
              />
            </div>
            ...
            <div className="flex flex-col gap-[12px]">
              ...
              <Item
                ...
                height={18}
                className=""
                value={numberFormatter(data?.totalSupply, 2, true, {
                  isShort: true
                })}
              />
            </div>
...
const Item = (props: any) => {
  ...
  return loading ? (
    ...
    <div
      className={`text-black font-Montserrat text-[20px] font-semibold leading-[90%] ${className}`}
      style={style}
    >
      {value}
    </div>
