  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        <div
          className='absolute z-[2] border-black leading-none rounded-[20px] border bg-[#FF80CC] text-[32px] rotate-[-5deg] px-[24px] pt-[18px] pb-[22px] shadow-shadow1 font-CherryBomb top-[-30px] left-[50%] translate-x-[-50%]'>
          Hot Sell Tokens
        </div>
        <div
            ...
            tokens.map((item, index) => (
              <div key={'pots' + index}
               className='overflow-hidden pb-[10px] last:overflow-visible last:pb-[0] last:mb-[-2px]'>
                <div
                     className='pt-[36px] px-[22px] flex flex-nowrap'>
                  {
