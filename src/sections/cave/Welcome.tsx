    ...
    <>
      ...
      <div className='absolute lg:w-[1000px] lg:bottom-[90px] lg:left-[50%] lg:translate-x-[-50%] md:w-full md:left-0 md:right-0 md:bottom-[200px]'>
        <svg
          ...
          className='cursor-pointer absolute right-[10px] top-[50px] hidden lg:block'
          width='33'
          height='33'
          viewBox='0 0 33 33'
          fill='none'
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                ...
                result='effect1_dropShadow_24372_359'
              />
              <feBlend
                mode='normal'
                in='SourceGraphic'
                in2='effect1_dropShadow_24372_359'
                result='shape'
              />
            </filter>
          </defs>
        ...
        <div className='bg-[#FFFDEB] lg:border border-[#000000] lg:rounded-[25px] md:rounded-tl-[25px] md:rounded-tr-[25px] px-[35px] py-[25px] shadow-[10px_10px_0px_0px_#00000040] md:pb-[16.153vw]'>
          <div className='flex gap-[10px] items-center hidden lg:block'>
