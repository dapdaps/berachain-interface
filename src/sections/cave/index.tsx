...
export default function Cave() {
  ...
  return (
    <div className="relative w-full h-full min-w-[1200px] min-h-[890px]">
                ...
                items.slice(0, -2).map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <img
                        src={`/images/cave/christmas/sock${item.pc_item ? '_has' : ''}.svg`}
                        alt="sock"
                      />
                      {
                        item.pc_item && (
...

              {
                items.slice(-2).map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      <img
                        src={index === 0 ? `/images/cave/christmas/gift_box_1${item.pc_item ? '_has' : ''}.png` : `/images/cave/christmas/gift_box_2${item.pc_item ? '_has' : ''}.png`}
                        alt="giftBox"
                      />
                      {
                        item.pc_item && (
                          <div className={clsx("absolute", index === 0 ? "right-[14px] top-[40px]" : "right-[-5px] top-[20px]")}>
                            <CheckBox
                              checked={item.checked}
                              onCheckChange={(isChecked) => {
                                setEqu({
      ...
      <div className="relative h-full w-full overflow-hidden">
        ...
        {/*#endregion*/}
        {/*#region Hats*/}
        <div className="flex items-end pr-[30px] absolute z-[2] w-[583px] left-[50%] top-[250px] translate-x-[-50%]">
          {
            hats.map(item => {
              return (
                <div
                  className="flex-1 relative cave-tip" onClick={(e) => {
                ...
                >
                  ...
                  />
                  {item.pc_item && <div className="absolute bottom-[0px] right-[15px]">
                    <CheckBox
                      checked={item.checked}
                      onCheckChange={(isChecked) => {
                        setEqu({
        ...
        <div className="absolute w-[583px] left-[50%] translate-x-[-50%] top-[355px] h-[398px] overflow-hidden">
          <div className="absolute w-[583px] top-[-80px] h-[398px] bg-[url('/images/cave/sheet-single-layer.png')] bg-contain bg-no-repeat bg-[position:top_80px_center]">
            <div className="flex pl-[40px] pr-[30px] pt-[125px]">
              {
                clothes.map(item => {
                  return (
                    <div
        ...
        >
          <img
            src={necklaces[0].pc_item ? necklaces[0].img : necklaces[0].img_not_owned}
        ...
        >
          <img
            src={necklaces[1].pc_item ? necklaces[1].img : necklaces[1].img_not_owned}
        ...
        >
          <img
            src={necklaces[2].pc_item ? necklaces[2].img : necklaces[2].img_not_owned}
            className="w-[71px] absolute left-[11px] top-[35px] cursor-pointer"
          />
        ...
        >
          <img
            src={necklaces[3].pc_item ? necklaces[3].img : necklaces[3].img_not_owned}
