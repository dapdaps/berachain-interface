      ...
      <AnimatePresence>
        {isMenuOpen && (
          ...
          >
            ...
            <div className='absolute h-9 bottom-[68px] left-0 right-0 flex px-4 items-center justify-between'>
                <div className="flex items-center gap-3">
                  <Link
                    className='z-[4] hover:scale-110 ease-in-out duration-300 w-[124px] h-[36px] rounded-full bg-[rgba(217,217,217,0.5)]'
                  ...
                  <img onClick={() => window.open('https://dapdap.mirror.xyz')} src="/images/mobile/mirror.png" className='w-9 h-9' alt="" />
                </div>
                <div
                  className="cursor-pointer"
                  onClick={() => {
