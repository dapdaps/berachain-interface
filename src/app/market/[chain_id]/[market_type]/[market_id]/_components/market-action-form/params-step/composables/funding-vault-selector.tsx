...
import { useVaultBalances } from "@/sdk/hooks";
  ...
  const vaults = useMemo(() => {
    ...
    return vaultMarkets.filter((vault) => {
      ...
      return (
        ...
        BigNumber.from(vaultBalance.raw_amount).gt(0)
      );
    });
