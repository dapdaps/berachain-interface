...
import { useExplore } from "@/stores/use-explore";
import cn from 'clsx';
...
export const Sorter = () => {
  ...
  return (
    ...
    <React.Fragment>
      ...
      >
        <SelectTrigger className="body-2 body-2 h-full w-[100px] shrink-0 rounded-xl border border-divider bg-white px-4 text-primary shadow-none drop-shadow-none lg:w-[180px]">
          <SelectValue
